...
<div class="container mx-auto px-4 py-6">
    <h1 class="text-2xl font-bold mb-6">Editar Plan: {{ $plan->nombre }}</h1>
    ...
    <form action="{{ route('administrador.planes.update', $plan->id) }}" method="POST" class="bg-white rounded-lg shadow-md p-6">
        @csrf
        @method('PUT')
        ...
        <div class="mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                <div>
                    ...
                    <input type="number" step="0.01" id="precio" name="precio" required value="{{ old('precio', $plan->precio) }}"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                    @error('precio')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <select id="moneda" name="moneda" required
                        ...
                        <option value="USD" {{ old('moneda', $plan->moneda) == 'USD' ? 'selected' : '' }}>Dólares (USD)</option>
                    </select>
                </div>
                <div>
                    ...
                    <select id="periodo_facturacion" name="periodo_facturacion" required
                        ...
                        <option value="año" {{ old('periodo_facturacion', $plan->periodo_facturacion) == 'año' ? 'selected' : '' }}>Año</option>
                    </select>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div>
                    ...
                    <input type="number" id="orden" name="orden" value="{{ old('orden', $plan->orden) }}"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                </div>
            ...
            <div class="mb-4">
                ...
                <textarea id="descripcion" name="descripcion" rows="3"
                    class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">{{ old('descripcion', $plan->descripcion) }}</textarea>
            </div>
        </div>
        ...
        <div class="mb-8">
            ...
            <div id="features-container" class="space-y-4">
                <!-- Mostrar características existentes -->
                @php
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-12 gap-4">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <div class="flex items-center mt-2">
                                    <input type="checkbox" class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded" name="caracteristicas[{{ $index }}][es_destacado]" value="1" {{ isset($caracteristica['es_destacado']) && $caracteristica['es_destacado'] ? 'checked' : '' }}>

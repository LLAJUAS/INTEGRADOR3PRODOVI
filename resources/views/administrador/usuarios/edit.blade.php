...
<div class="min-h-screen bg-gray-50 py-8">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8 animate-fade-up">
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-600">Modifica la información del usuario seleccionado.</p>
                </div>
        ...
        <div class="bg-white rounded-2xl overflow-hidden animate-fade-up" style="animation-delay: 0.1s">
            {{-- Alerta de Errores --}}
            @if ($errors->any())
            ...
            <form action="{{ route('administrador.usuarios.update', $user->id) }}" method="POST">
                ...
                <div class="mb-8">
                    <h2 class="text-lg font-semibold text-gray-900 mb-4 flex items-center">
                        ...
                        Seguridad
                        <span class="ml-2 text-xs text-gray-500 font-normal">(Deja en blanco para mantener la contraseña actual)</span>
                    </h2>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {{-- Contraseña --}}
                        <div>

...
<div class="max-w-4xl mx-auto">
    <div class="bg-white shadow rounded-lg overflow-hidden">
        ...
        <div class="p-6 space-y-6">
            ...
            <div>
                <div class="flex justify-between items-center">
                    ...
                    <a href="{{ route('administrador.tareas.archivos.create', $tarea->id) }}" class="inline-flex items-center px-3 py-1 border border-transparent text-xs font-medium rounded shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
        ...
        <div class="bg-gray-50 px-6 py-4 flex justify-between items-center">
            ...
            <div class="space-x-3">
                <a href="{{ route('administrador.tareas.edit', $tarea->id) }}" class="inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                    Editar tarea
                </a>
            </div>
        </div>
